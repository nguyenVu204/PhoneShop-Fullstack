namespace PhoneShop.API.Services.VnPay
{
    ...
    public class VnPayService : IVnPayService
    {
        ...
        public string CreatePaymentUrl(HttpContext context, VnPayPaymentRequestModel model)
        {
            ...
            vnpay.AddRequestData("vnp_Amount", (model.Amount * 100).ToString()); // Quy tắc: Nhân 100
            ...
            vnpay.AddRequestData("vnp_ReturnUrl", "http://localhost:5173/payment-result"); // Link Frontend nhận kết quả
