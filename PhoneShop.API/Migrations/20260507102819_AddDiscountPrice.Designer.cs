...
namespace PhoneShop.API.Migrations
{
    ...
    [Migration("20260507102819_AddDiscountPrice")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PhoneShop.API.Models.News", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PhoneShop.API.Models.NewsCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PhoneShop.API.Models.NewsCategoryMapping", b =>
                {
            ...
            modelBuilder.Entity("PhoneShop.API.Models.NewsComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PhoneShop.API.Models.News", b =>
                {
                    b.HasOne("PhoneShop.API.Models.Product", "RelatedProduct")
                        .WithMany()
            ...
            modelBuilder.Entity("PhoneShop.API.Models.NewsCategoryMapping", b =>
                {
                    b.HasOne("PhoneShop.API.Models.NewsCategory", "Category")
                        .WithMany("NewsMappings")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PhoneShop.API.Models.News", "News")
