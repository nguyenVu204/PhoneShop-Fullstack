...
import ImeiManagerModal from "./ImeiManagerModal";
...
export default function ProductEdit() {
  ...
  const [selectedVariantForImei, setSelectedVariantForImei] = useState(null);
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-4">
          ...
          <h1 className="text-2xl font-bold text-gray-800">
            Sửa sản phẩm: <span className="text-blue-600">#{id}</span>
          </h1>
        </div>
        <button
          onClick={handleSubmit}
          disabled={uploading}
          className="bg-blue-600 text-white px-6 py-2 rounded-lg font-bold flex items-center space-x-2 hover:bg-blue-700 shadow disabled:opacity-50"
        >
          <Save size={20} />{" "}
          <span>{uploading ? "Đang xử lý..." : "Lưu thay đổi"}</span>
        </button>
      </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="flex gap-2">
                <label
                  className={`flex items-center justify-center px-3 py-2 bg-blue-50 text-blue-600 rounded border border-blue-200 cursor-pointer hover:bg-blue-100 transition ${uploading ? "opacity-50" : ""}`}
                >
                  {uploading ? (
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="col-span-2">
                    ...
                    <div className="flex gap-1">
                      ...
                      <label
                        className={`w-9 h-9 flex items-center justify-center bg-blue-50 text-blue-600 border border-blue-200 rounded cursor-pointer hover:bg-blue-100 ${uploading ? "opacity-50" : ""}`}
                      >
                        {uploading ? (
